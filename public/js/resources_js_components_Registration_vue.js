...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    nameErrors: function nameErrors() {
      var errors = []; // if (!this.$v.name.required) errors.push('Обязательное поле для заполенения')

      if (!this.$v.name.minLength) errors.push('Имя должно быть не менее 2 символов'); // if (!this.$v.name.alphaNum) errors.push('Имя должно состоять только из букв')
            ...
            _c("form", { staticClass: "space-y-6" }, [
              _c("div", [
                ...
                _c("div", { staticClass: "mt-1" }, [
                  _c("input", {
                    ...
                    on: {
                      submit: function ($event) {
                        ...
                        return _vm.nameErrors.apply(null, arguments)
                      },
                  ...
                  _vm._v(" "),
                  _vm.$v.name.$error
                    ? _c("p", { staticClass: "text-gray-400 text-sm\tmt-1" }, [
