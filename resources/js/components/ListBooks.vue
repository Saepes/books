<template>
   <div class="flex flex-wrap mx-4">
      <div class="w-full md:w-1/2 xl:w-1/4 px-4" v-for="book in books" :key="book.id">
         <div class="bg-white rounded-lg overflow-hidden mb-10">
            <img src="https://cdn.tailgrids.com/1.0/assets/images/cards/card-01/image-01.jpg" class="w-full"/>
